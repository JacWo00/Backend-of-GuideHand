...
public class Token
{
    ...
    private final String secretId = null; // 填入腾讯云AKSK密钥(从腾讯云控制台获取)
    private final String secretKey = null; // 填入腾讯云AKSK密钥(从腾讯云控制台获取)
    private final int connTypeApi = 5; // API 访客
    private static String botAppkey = null;  // 机器人密钥，不是BotBizId (从运营接口人处获取)
